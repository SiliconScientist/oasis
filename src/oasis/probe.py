...
if __name__ == "__main__":
    ...
    for reaction, entry in dataset_items:
        ...
        trajectory_frames = build_entry_trajectory_frames(
            ...
            bare_surface_wrapped=bare_surface,
            adsorption_sites=adsorption_sites,
            nearby_site_adsorbates=nearby_site_adsorbates,
            unique_probe_sequence=entry_unique_probe_sequence,
        )
        if reaction == "Pt3Rh_Pt3M_Tol":
            print("Stop here to inspect trajectory_frames for one entry")
