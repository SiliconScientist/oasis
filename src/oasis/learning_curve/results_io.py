...
_METHOD_RESULT_FIELDS = {
    ...
    "current_best_mlip": "current_best_mlip_df",
...
_METHOD_SELECTION_FIELDS = {
    ...
    "current_best_mlip": "current_best_mlip_selection_df",
...
_METHOD_UQ_FIELDS = {
    ...
    "current_best_mlip": "current_best_mlip_uq_df",
...
def learning_curve_uq_field_for_method_name(method_name: str) -> str | None:
    return _METHOD_UQ_FIELDS.get(method_name)
